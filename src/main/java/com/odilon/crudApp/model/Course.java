...
public class Course implements Serializable {
    ...
    private CDefinition courseDefinition;

	public Course() {
		super();
	}

	public Course(String id, String student_id, String academic_unit_id, String teacherID, String semester,
				  String coursedefinitionid, Student student, AcademicUnit academicUnit, Teacher teacher,
				  Semester semesterInfo, CDefinition courseDefinition) {
		super();
		this.id = id;
	...
	public CDefinition getCourseDefinition() {
		return courseDefinition;
	}

	public void setCourseDefinition(CDefinition courseDefinition) {
		this.courseDefinition = courseDefinition;
	}
